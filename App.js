...
function QuickPhotoMeasure({job,onBack,onUpdate}){
...
export default function App(){
  ...
  let content;
  if(screen==='welcome')content=<Welcome onStart={()=>setScreen('modeHome')}/>;
  ...
  else if(screen==='quickForm')content=<QuickMeasurementForm onBack={()=>setScreen('modeHome')} onContinue={j=>{setQuickJob(j);setScreen('quickPhoto')}}/>;
  else if(screen==='quickPhoto')content=<QuickPhotoMeasure job={quickJob} onBack={()=>setScreen('modeHome')} onUpdate={setQuickJob}/>;

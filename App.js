...
function QuickPhotoMeasure({job,onBack,onUpdate,onSave,onFinish}){
  ...
  const requestMorePhoto=()=>{
    if(photoDirty){Alert.alert('Salve esta foto primeiro','Salve primeiro o trabalho desta foto antes de abrir outra. Toque em “Salvar foto” e depois volte ao botão Foto.');return;}

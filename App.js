...
function Home({ onQuick, onNew, onProjects, onClients, onHelp, onMore }) {
  ...
  return <View style={styles.screen}>
    ...
    <ScrollView style={{flex:1}} contentContainerStyle={styles.homeCleanBody} showsVerticalScrollIndicator={false}>
      ...
      <Pressable onPress={onProjects} style={styles.homeProjectsShortcut}><Text style={styles.homeProjectsShortcutIcon}>▣</Text><View style={{flex:1}}><Text style={styles.homeProjectsShortcutTitle}>Meus projetos</Text><Text style={styles.homeProjectsShortcutText}>Consulte medições salvas, fotos e plantas.</Text></View><Text style={styles.homeChoiceArrow}>›</Text></Pressable>
    </ScrollView>

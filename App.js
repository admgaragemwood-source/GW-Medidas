...
function QuickPhotoMeasure({job,onBack,onUpdate,onSave,onFinish}){
  ...
  const requestMorePhoto=()=>{
    if(photoDirty){Alert.alert('Salve esta foto primeiro','Você fez alterações nesta foto. Toque em “Salvar foto” antes de adicionar outra para não perder o trabalho.');return;}
